  ...
  constructor(
    ...
    this.datosCompartidosService.cargandoIngresoDatosCliente.subscribe(
      cargandoIngresoDatosCliente => {
        ...
        if (cargandoIngresoDatosCliente) {//Si cargandoIngresoDatosCliente es verdadero
          //this.router.navigate(['about-us']);//Redirige al usuario a la página de ingreso de datos del cliente
        }
    ...
    this.datosCompartidosService.habitacionesSeleccionadasCliente.subscribe(
      habitacionesSeleccionadasCliente => {
        ...
        if (this.habitacionesSeleccionadasCliente === null) {
          // No se ha seleccionado ninguna habitación, redirige al usuario o muestra un mensaje de error
